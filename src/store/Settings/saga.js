...
import { GET_ALL_COMPANY_SETTINGS, GET_ALL_COMPANY_SETTINGS_SUCCESS, GET_ALL_SURCHARGE_CATEGORY, GET_ALL_SURCHARGE_CATEGORY_SUCCESS, GET_BUSINESS_DATA, GET_BUSINESS_DATA_SUCCESS, GET_COMPANYDETAILS_BASIC_DATA, GET_COMPANYDETAILS_BASIC_DATA_SUCCESS, GET_COMPANYDETAILS_DATA, GET_COMPANY_ADD_USERS_DATA, GET_COMPANY_ADD_USERS_DATA_SUCCESS, GET_COMPANY_CITY_DATA, GET_COMPANY_CITY_DATA_SUCCESS, GET_COMPANY_COUNTRY_DATA, GET_COMPANY_COUNTRY_DATA_SUCCESS, GET_COMPANY_PINCODE_DATA, GET_COMPANY_PINCODE_DATA_SUCCESS, GET_COMPANY_PIN_CODE_DATA_SUCCESS, GET_COMPANY_STATE_DATA, GET_COMPANY_STATE_DATA_SUCCESS, GET_FCL_SURCHARGE_TABLE_DATA, GET_PARTIES_CUSTOMERS_DETAILS, GET_PARTIES_CUSTOMERS_DETAILS_SUCCESS, GET_PARTIES_SURCHARGE_ALIAS_TABLE, GET_PARTIES_SURCHARGE_ALIAS_TABLE_SUCCESS, GET_PARTIES_SURCHARGE_TABLE, GET_PARTIES_SURCHARGE_TABLE_SUCCESS, GET_TAXES_DATA, GET_TAXES_DATA_SUCCESS, GET_USERS_TABLE_DATA, GET_USERS_TABLE_DATA_SUCCESS, POST_SETTINGS_SURCHARGE_DATA, POST_SETTINGS_SURCHARGE_DATA_SUCCESS } from "./actiontype"
...
function* getCompanyAddUserData({ payload }) {
    try {
        ...
        // showErrorToast(error?.message);
        console.log(error, "saga getCompanyAddUserData api error")
    }
}
...
function* getAllPartiesSurchargeAliasTable(){
    try {
        ...
        console.log(response, "reponse into getAllPartiesCompanySettings")
        yield put({ type: GET_PARTIES_SURCHARGE_ALIAS_TABLE_SUCCESS, payload: response});
    } catch (error) {
        console.log(error, "saga getAllCompanySettings api error");
    }
}
...
export function* watchGetSettingsUsersData() {
    ...
    yield takeLatest(GET_PARTIES_SURCHARGE_ALIAS_TABLE, getAllPartiesSurchargeAliasTable)
