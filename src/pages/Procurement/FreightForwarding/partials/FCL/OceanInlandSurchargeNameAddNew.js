...
import ModalInlandAddNewAlias from "./Modal/ModalInlandAddNewAlias";
...
export default function OceanInlandSurchargeNameAddNew() {
      ...
      <div className="page-content">
        <Container fluid>
          <div className="main_freight_wrapper surcharges_add_form_wrap">
            ...
            /> */}
            <ModalInlandAddNewAlias modal={aliasModal} onCloseClick={onCloseClick} />
          </div>
        </Container>
      </div>
    </>
