          ...
          <div className="table_view_data_wrap">
            <div className="view_details_wrap">
              ...
              <div className="row view_data_wrap">
                    ...
                    <>
                      ...
                      >
                        <AccordionItem key={item.id}>
                          ...
                          <AccordionBody style={{fontSize:"13px"}} accordionId={`main_${index}`}>
                            {/* <div className="table_view_data_wrap"> */}
                            {/* <div className="view_details_wrap"> */}
                            {/* <div className="top_details"> */}
                            {/* <div className="d-flex justify-content-around"> */}
                ...
                <CardBody>
                            <div style={{fontWeight:"500"}} className="row">
                              <div className="col-3">
                                <div className="py-2">
                            ...
                            <div className="row">
                              ...
                              <div className="col-lg-3">
                                {item.addTerms.incoTerm.map((val, key) => (
                                  <div
                                    key={key}
                                    className="p-2 mb-2"
                                  >
                              ...
                              <div className="col-lg-3">
                                {item.addTerms.commodity.map((val, key) => (
                                  <div
                                    key={key}
                                    className="p-2 mb-2"
                                  >
                              ...
                              <div className="col-lg-3">
                                {item.addTerms.serviceType.map((val, key) => (
                                  <div
                                    key={key}
                                    className="p-2 mb-2"
                                  >
