...
const ModalAirConsole = ({ viewData, modal, onCloseClick, modalType }) => {
    const ref = useRef();
                                ...
                                <div className="table_view_popup_table">
                                    <SimpleBar style={{ maxHeight: "400px", maxWidth: '100%' }} ref={ref}>
                                            <table style={{ minWidth: '800px' }}>
                                                ...
                                                <tbody>
                                                    {viewData?.tenantConsoleFreightRPS !== undefined && viewData?.tenantConsoleFreightRPS?.map((item, index) => (
                                                        <tr key={index}>
                                                    ...
                                                    {(viewData?.tenantConsoleFreightRPS?.length === 0 || viewData?.tenantConsoleFreightRPS === undefined) && (
                                                        <tr>
...
export default ModalAirConsole
