                                ...
                                <CardBody>
                                    <Toast isOpen={toast1}>
                                        <ToastHeader toggle={() => setToast1(!toast1)}>
                                            ...
                                            <small className='text-muted' style={{ marginLeft: "170px" }}>06 mins ago</small>
                                        </ToastHeader>
                                        <ToastBody>
                                            Hello, world! This is a toast message.
                                        </ToastBody>
                                                ...
                                                <Toast isOpen={toast3}>
                                                    <ToastHeader toggle={() => setToast3(!toast3)}>
                                                        <img src={logo} className="rounded me-2"
                                                            alt="..." height="20" />
                                                        <span className="fw-semibold me-auto">Minia</span>
                                                        <small className='text-muted'  style={{ marginLeft: "185px" }}>Just now</small>
                                                    </ToastHeader>
                                                    <ToastBody>
                                                        See? Just like this.
                                                    </ToastBody>
                                                ...
                                                <Toast isOpen={toast4}>
                                                    <ToastHeader toggle={() => setToast4(!toast4)}>
                                                        <img src={logo} className="rounded me-2"
                                                            alt="..." height="20" />
                                                        <span className="fw-semibold me-auto">Minia</span>
                                                        <small className='text-muted' style={{ marginLeft: "160px" }}>2 seconds ago</small>
                                                    </ToastHeader>
                                                    <ToastBody>
                                        ...
                                        <div className={"toast-container position-absolute p-3 " + position} id="toastPlacement">
                                            <Toast isOpen={toast9}>
                                                <ToastHeader toggle={() => setToast9(!toast9)}>
                                                    ...
                                                    <small className='text-muted' style={{ marginLeft: "170px" }}>11 mins ago</small>
                                                </ToastHeader>
                                                <ToastBody>
                                                    Hello, world! This is a toast message.
                                                </ToastBody>
