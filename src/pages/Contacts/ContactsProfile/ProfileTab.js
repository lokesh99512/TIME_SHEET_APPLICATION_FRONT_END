        ...
        <React.Fragment>
            <Row>
                ...
                <Col xl={3} lg={4}>
                    <Card>
                        <CardBody>
                            <CardTitle className="mb-3"><h5 className="font-size-15">Skills</h5></CardTitle>
                    ...
                    <Card>
                        <CardBody>
                            <CardTitle className="mb-3"><h5 className="font-size-15">Portfolio</h5></CardTitle>
                    ...
                    <Card>
                        <CardBody>
                            <CardTitle className="mb-3"><h5 className="font-size-15">Similar Profiles</h5></CardTitle>
