...
const TableProject = ({ columns, data, isGlobalFilter,activeProject, customPageSize, toggleRightCanvas, component, loader, setCurrentPage, totalPages, totalEntries }) => {
    ...
    return (
        <>
            <div className="freight_filter_wrap d-flex align-items-center">
                <p className="label flex-grow-1 m-0">Task Filters :</p>
                ...
                <div className="right_actions_wrap flex-shrink-0 d-flex align-items-center">
                    ...
                    <div className="add_btn">
                        <button className='border-0' onClick={() => { navidate(`/add/task`,
                            {
                                state: {
                                  id:activeProject.id || '',
                                },
