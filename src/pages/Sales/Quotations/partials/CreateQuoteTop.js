...
import { countryList, optionAirTransportBy, optionCargoType, optionContainerType, optionCurrency, optionCustomerName, optionIncoterm, optionPortList, optionServiceType, optionTransportBy, optionlocationType, weightUnitOption } from '../../../../common/data/sales';
...
import { UPDATE_SEARCH_QUOTATION_CURRENCY, UPDATE_SEARCH_QUOTATION_DATA, UPDATE_SEARCH_QUOTATION_DATE, UPDATE_SEARCH_QUOTATION_LOCATION_FROM, UPDATE_SEARCH_QUOTATION_LOCATION_TO, UPDATE_SEARCH_QUOTATION_SWAP } from '../../../../store/Sales/actiontype';

export default function CreateQuoteTop() {
    const [isOpen, setIsOpen] = useState(false);
    const [dropId, setDropId] = useState(false);
    const [weightUnit, setWeightUnit] = useState('KG');
    const [dimentionUnit, setDimentionUnit] = useState('IN');
            ...
            <div className="create_sales_search_forms">
                ...
                <div className="row">
                    ...
                    {createFields?.service_type?.value && (
                        <>
                            {createFields?.shipping_by?.value === 'sea' && (
                                <>
                                    <div className="col-lg-4">
                                        <div className="common_dropdwon_btn_wrap mb-3">
                                            <div
                                            ...
                                            {isOpen && dropId === 4 ?
                                                <ul className="common_dropdown_wrap" ref={dropdownRef}>
                                                    {(createFields?.shipping_by?.value === 'air' ? optionAirTransportBy : optionTransportBy || '').map(({ value, name }, index) => (
                            ...
                            {(createFields?.transport_by?.value === 'lcl' || createFields?.transport_by?.value === 'console' || createFields?.transport_by?.value === 'master_waybill') && (
                                <div className="col-lg-4">
                                    <div className="common_dropdwon_btn_wrap mb-3">
                                        <div
                                            id='more_menu'
                                                            ...
                                                            <AccordionBody accordionId={`${index + 1}`}>
                                                                <div className="field_wrap">
                                                                    <div className="input_field">
                                                                        ...
                                                                        <input type="number" className="form-control" id={`no_unit_${index}`} onChange={(e) => { contanerTypeValHandler(e.target.value,'no_unit',index); }} />
                                                                    </div>
                                                                    <div className="input_field field_dropdown">
                                                                        <label htmlFor={`weight_${index}`} className="form-label">weight</label>
                                                                        <input type="number" className="form-control" id={`weight_${index}`} onChange={(e) => { contanerTypeValHandler(e.target.value,'weight',index); }} />
                                                                        <UncontrolledDropdown>
                                                                            ...
                                                                            <DropdownMenu className="dropdown-menu-end">
                                                                                {(weightUnitOption || '').map((item) => (
                                                                                    <DropdownItem key={item?.value} onClick={() => {setWeightUnit(item?.name);contanerTypeValHandler(item?.name,'weight_unit',index);}}>{item?.name}</DropdownItem>
                                                                                ))}
                                                                            </DropdownMenu>
                                                                        </UncontrolledDropdown>
                                                                    </div>
                                                                ...
                                                                <div className="dimention_field mt-3">
                                                                    ...
                                                                    <div className="input_field_wrap d-flex">
                                                                        <div className="input_field dimention_l">
                                                                            <input type="number" className="form-control" id={`dimensions_l_${index}`} onChange={(e) => { contanerTypeValHandler(e.target.value,'dimensions_l',index); }}/>
                                                                        </div>
                                                                        <div className="input_field dimention_w">
                                                                            <input type="number" className="form-control" id={`dimensions_w_${index}`} onChange={(e) => { contanerTypeValHandler(e.target.value,'dimensions_w',index); }}/>
                                                                        </div>
                                                                        <div className="input_field dimention_h">
                                                                            <input type="number" className="form-control" id={`dimensions_h_${index}`} onChange={(e) => { contanerTypeValHandler(e.target.value,'dimensions_h',index); }}/>
                                                                        </div>
                                                                        <div className="input_field">
                                                                            <UncontrolledDropdown>
