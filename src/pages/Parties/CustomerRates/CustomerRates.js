    ...
    return (
        <>
            <div className="page-content">
                <Container fluid>
                    <div className="create_sales_wrapper instant_rate_wrapper customer_rate_wrapper">
                        <div className="create_sales_wrapper_inner">
                            <div className="d-flex justify-content-end main_tab_wrap">
                                ...
                                <button type="button" className={`btn d-flex align-items-center ms-3 ${mainactiveTab === "air_freight" ? "active" : ""}`}
                                    onClick={() => { setMainactiveTab("air_freight"); toggleTab("DOM_MAWB_FREIGHT"); }}>
                            ...
                            <div className="row align-items-center mb-4" >
                                <div className="col-12 col-md-6">
                                    <div className="position-relative align-items-end d-flex">
                                ...
                                {mainactiveTab === "ocean_freight" ? (
                                    ...
                                    <React.Fragment>
                                        ...
                                        <NavItem>
                                            ...
                                            ><i className='bx bx-rocket mx-1'></i>DOM-CONSOLE Freight</NavLink>
                                        </NavItem>
                                        <NavItem>
                                            <NavLink
                                                href="#"
