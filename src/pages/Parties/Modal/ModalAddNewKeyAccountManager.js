...
const ModalAddNewKeyAccountManager = ({ modal, onCloseClick }) => {
  return (
    <>
            ...
            <div className="charge_details">
              ...
              <div className="row mt-4 mb-2">
                <div className="col-12 col-sm-12 col-md-12 col-lg-12 mb-4">
                  {/* <div className="row"> */}
                    <label className="form-label">Key Account Manager Name</label>
                    {/* <div className="col-9"> */}
                      <Input
                        type="text"
                        //   name="surchargeCode"
                        ...
                        placeholder="Enter Key Account Manager Name"
                      />
                    {/* </div> */}
                  {/* </div> */}
                </div>
...
export default ModalAddNewKeyAccountManager;
