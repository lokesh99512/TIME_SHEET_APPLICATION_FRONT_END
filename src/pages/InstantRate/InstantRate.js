                ...
                <Container fluid>
                    <div className="create_sales_wrapper instant_rate_wrapper">
                        <div className="d-flex justify-content-end main_tab_wrap">
                            <button type="button" className={`btn d-flex align-items-center ${mainactiveTab === "ocean_freight" ? "active" : ""}`} onClick={() => { setMainactiveTab("ocean_freight");toggleTab("FCL"); }}>
                            ...
                            <button type="button" className={`btn d-flex align-items-center ms-3 ${mainactiveTab === "air_freight" ? "active" : ""}`} onClick={() => { setMainactiveTab("air_freight");toggleTab("dom_air"); }}>
